...
1. **Python and Ruby** — both have Sourcegraph-first-party SCIP indexers (`scip-python`, `scip-ruby`); should be straightforward additions following the pattern in `internal/sources/golang`. Python is probably the highest-leverage next language for AI agents.
