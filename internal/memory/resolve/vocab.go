...
var synonyms = func() map[string]mapping {
	...
	add(RelConflictsWith, false, "conflicts_with", "conflicts", "contradicts", "contradicted_by", "diverges_from", "diverged_from", "differs_from", "disagrees_with", "incompatible_with", "collides_with", "competes_with", "resolves_collision", "violates", "violates_spec", "spec_violation", "breaks")
	...
	add(RelTests, false, "tests", "test", "tested", "verified", "verified_on", "confirmed", "validated", "tested_in", "tested_via", "verifies", "verify", "verified_against", "verified_in", "validates", "validates_against", "validate", "checks", "checked", "check", "covers", "cover", "covers_contract", "covers_branch", "exercises", "proves", "confirms", "audits", "audited", "inspected", "investigates", "researched", "reproduced", "evaluated", "diagnosed", "scans", "measures", "mocks", "ran_tests_on", "adds_tests", "adds_regression_for", "has_test", "has_tests", "has_test_suite", "has_property_tests", "has_test_contract", "enforces_coverage_on")
